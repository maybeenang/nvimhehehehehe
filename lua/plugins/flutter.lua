return {
	...
	config = function()
		require("flutter-tools").setup({
			...
			-- flutter_path = "<full/path/if/needed>", -- <-- this takes priority over the lookup flutter_lookup_cmd = nil, -- example "dirname $(which flutter)" or "asdf where flutter"
			...
			outline = {
				open_cmd = "25vnew", -- command to use to open the outline buffer
